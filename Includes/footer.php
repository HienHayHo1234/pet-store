        ...
        <div class="footer-section">
            <h4>Cổng thanh toán</h4>
                    <div class="payment-icons">
                        <img src="../asset/images/icon/momo.png" alt="Momo">
                        <img src="../asset/images/icon/zalopay.png" alt="Zalopay">
                        <img src="../asset/images/icon/paypal.png" alt="Paypal">
                        <img src="../asset/images/icon/visa.png" alt="Visa">
                    </div>
                </div>
            </div>
